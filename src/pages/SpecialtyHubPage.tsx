...
export default function SpecialtyHubPage() {
  ...
  const relatedQuestions = useMemo(() => { const generated=virtualQuestionsForSpecialty(slug,lang,50); const local=loadedQuestions.filter(q=>(q as any).language===lang || ((q as any).translations ? Boolean((q as any).translations?.[lang]) : !(q as any).language)); return [...local,...generated].slice(0,50); }, [loadedQuestions,slug,lang]);
