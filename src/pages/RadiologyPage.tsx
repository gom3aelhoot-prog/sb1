            ...
            {centers.map((c) => (
              <div key={c.id} className="card overflow-hidden hover:shadow-lg transition-all">
                ...
                <div className="p-5">
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-2"><button onClick={() => navigate('/radiology/'+c.id)} className="btn-secondary w-full text-sm">تفاصيل المؤسسة</button><button onClick={() => setBookingCenter(c)} className="btn-primary w-full text-sm flex items-center justify-center gap-2">
