...
export default function WalletPage(){
 ...
 const [wallet,setWallet]=useState<any>(null);const [tx,setTx]=useState<any[]>([]);const [amount,setAmount]=useState('25');const [busy,setBusy]=useState(false);const [message,setMessage]=useState('');
