...
import { COUNTRY_OPTIONS, CURRENCY_RATES, type CountryInfo } from '@/types/i18n';
...
const countryMultiplier:Record<string,number>={US:1,DE:.95,RU:.85,UZ:.65,AM:.65,TJ:.65,UA:.75,AZ:.75,GE:.7,ET:.55,SA:1,AE:1.05,EG:.78,IQ:.78,JO:.88,KW:1.08,LB:.55,LY:.66,MA:.66,OM:1.05,PS:.88,QA:1.02,SY:.55,TN:.66,YE:.55,DZ:.66,BH:1.04,MR:.55,SD:.55,SO:.55,KM:.55,DJ:.55};
