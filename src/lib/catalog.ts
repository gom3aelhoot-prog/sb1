...
const facilityKinds=[['clinic','clinic'],['lab','lab'],['radiology','radiology'],['elderly','elderly'],['pharmacy','pharmacy'],['addiction','addiction'],['rehab','rehab'],['medical-supplies','medical-supplies'],['property','property']] as const;
const facilityNames:Record<string,Record<string,string>>={
 ar:{clinic:'عيادة',lab:'مختبر تحاليل',radiology:'مركز أشعة',elderly:'دار رعاية المسنين',pharmacy:'صيدلية',addiction:'مركز علاج الإدمان',rehab:'مركز التأهيل والعلاج الطبيعي','medical-supplies':'أدوات وأجهزة طبية',property:'أماكن طبية للبيع أو الإيجار'},
 en:{clinic:'Clinic',lab:'Laboratory',radiology:'Radiology Center',elderly:'Elderly Care',pharmacy:'Pharmacy',addiction:'Addiction Treatment',rehab:'Rehabilitation & Physiotherapy','medical-supplies':'Medical Equipment & Supplies',property:'Medical Places for Sale or Rent'},
 ru:{clinic:'Клиника',lab:'Лаборатория',radiology:'Радиологический центр',elderly:'Уход за пожилыми',pharmacy:'Аптека',addiction:'Лечение зависимостей',rehab:'Реабилитация и физиотерапия','medical-supplies':'Медицинское оборудование',property:'Медицинские объекты на продажу или аренду'},
 de:{clinic:'Klinik',lab:'Labor',radiology:'Radiologiezentrum',elderly:'Seniorenpflege',pharmacy:'Apotheke',addiction:'Suchtbehandlung',rehab:'Rehabilitation & Physiotherapie','medical-supplies':'Medizinische Geräte',property:'Medizinische Objekte zum Verkauf oder zur Miete'},
 uk:{clinic:'Клініка',lab:'Лабораторія',radiology:'Радіологічний центр',elderly:'Догляд за літніми',pharmacy:'Аптека',addiction:'Лікування залежностей',rehab:'Реабілітація та фізіотерапія','medical-supplies':'Медичне обладнання',property:'Медичні об’єкти на продаж або оренду'},
 uz:{clinic:'Klinika',lab:'Laboratoriya',radiology:'Radiologiya markazi',elderly:'Keksalar parvarishi',pharmacy:'Dorixona',addiction:'Giyohvandlikni davolash',rehab:'Reabilitatsiya va fizioterapiya','medical-supplies':'Tibbiy uskunalar',property:'Sotish yoki ijaraga tibbiy joylar'},
 hy:{clinic:'Կլինիկա',lab:'Լաբորատորիա',radiology:'Ռադիոլոգիայի կենտրոն',elderly:'Տարեցների խնամք',pharmacy:'Դեղատուն',addiction:'Կախվածությունների բուժում',rehab:'Վերականգնում և ֆիզիոթերապիա','medical-supplies':'Բժշկական սարքավորումներ',property:'Բժշկական տարածքներ վաճառքի կամ վարձակալության'},
 tg:{clinic:'Клиника',lab:'Озмоишгоҳ',radiology:'Маркази радиология',elderly:'Нигоҳубини пиронсолон',pharmacy:'Дорухона',addiction:'Табобати вобастагӣ',rehab:'Барқарорсозӣ ва физиотерапия','medical-supplies':'Таҷҳизоти тиббӣ',property:'Объектҳои тиббӣ барои фурӯш ё иҷора'},
 az:{clinic:'Klinika',lab:'Laboratoriya',radiology:'Radiologiya mərkəzi',elderly:'Yaşlılara qayğı',pharmacy:'Aptek',addiction:'Asılılıq müalicəsi',rehab:'Reabilitasiya və fizioterapiya','medical-supplies':'Tibbi avadanlıq',property:'Satış və ya icarə üçün tibbi obyektlər'},
 am:{clinic:'ክሊኒክ',lab:'ላቦራቶሪ',radiology:'ራዲዮሎጂ ማዕከል',elderly:'የአረጋውያን እንክብካቤ',pharmacy:'ፋርማሲ',addiction:'የሱስ ሕክምና',rehab:'ማገገሚያ እና ፊዚዮቴራፒ','medical-supplies':'የሕክምና መሣሪያዎች',property:'የሕክምና ቦታዎች ለሽያጭ ወይም ኪራይ'},
 ka:{clinic:'კლინიკა',lab:'ლაბორატორია',radiology:'რადიოლოგიის ცენტრი',elderly:'ხანდაზმულთა მოვლა',pharmacy:'აფთიაქი',addiction:'დამოკიდებულების მკურნალობა',rehab:'რეაბილიტაცია და ფიზიოთერაპია','medical-supplies':'სამედიცინო მოწყობილობები',property:'სამედიცინო ობიექტები გასაყიდად ან გასაქირავებლად'}
};
